...
class Year15Day9 : Day<List<String>>() {
  ...
  override fun part1(input: List<String>): Int = solveTSP(distanceMap(input)) { collection -> collection.minOrNull() ?: 0 }

  override fun part2(input: List<String>): Int = solveTSP(distanceMap(input)) { collection -> collection.maxOrNull() ?: 0 }
