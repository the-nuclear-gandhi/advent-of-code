...
class Year15Day11: Day<String>() {
  ...
  private fun isValidPassword(chars: CharArray) =
    ...
    chars.filterIndexed { index, c -> index < chars.size - 2 && chars[index+1] - c == 1 && chars[index+2] - c == 2 }.any() &&
    chars.filterIndexed { index, c -> index < chars.size - 1 && chars[index+1] == c && chars[index-1] != c }.count() > 1
}
